...
[T008] Configured for SQLModel with asyncpg driver and Neon PostgreSQL.
"""
...
if database_url:
    ...
    if database_url.startswith("postgresql+asyncpg://"):
        ...
        sync_url = database_url.replace("postgres+asyncpg://", "postgres://", 1)
    else:
        sync_url = database_url

    # Remove SSL parameters from URL (Alembic handles SSL differently)
